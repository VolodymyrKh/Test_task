export const serviceData = [
  ...
  },
  {
    ...
    img: "./img/Manage.svg",
    content:
      "Our directory is accessed by families across US and Canada to find local service providers and facilities by profession, services offered, or ratings and rankingsWe match families based on their needs.",
  },
  {
    id: 3,
...
export const sliderData = [
  { id: 11, img: "./img/slider/img-1.jpg", position: "sales agent" },
  { id: 12, img: "./img/slider/img-2.jpg", position: "city business owner" },
  { id: 13, img: "./img/slider/img-3.jpg", position: "tutor" },
  { id: 14, img: "./img/slider/img-4.jpg", position: "financial advisor" },
  { id: 15, img: "./img/slider/img-5.jpg", position: "personal care giver" },
  { id: 16, img: "./img/slider/img-6.jpg", position: "yoga trainer" },
  { id: 17, img: "./img/slider/img-7.jpg", position: "nutritionist" },
